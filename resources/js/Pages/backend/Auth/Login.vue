...
<template>
    <GuestLayout>
        ...
        <div class="mb-6 text-center">
            ...
            <p class="text-sm text-gray-500 mt-1">Enter your details to access your account</p>
        </div>

        <div v-if="status" class="mb-4 text-sm font-medium text-emerald-600 bg-emerald-50 p-3 rounded-md">
            {{ status }}
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <div>
                <div class="flex items-center justify-between mb-1">
                    ...
                    <Link v-if="canResetPassword" :href="route('password.request')" class="text-xs font-medium text-emerald-700 hover:text-emerald-800">
                        Forgot password?
                    </Link>
                </div>
                <div class="relative">
            ...
            <div class="pt-2 space-y-3">
                ...
                <div class="relative flex py-1 items-center">
                    ...
                    <span class="flex-shrink mx-3 text-xs text-gray-400 uppercase tracking-wider font-semibold">Or continue with</span>
                    <div class="flex-grow border-t border-gray-200"></div>
                </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <Link :href="route('register')" class="font-medium text-emerald-700 hover:text-emerald-800">
                        Register
                    </Link>
                </p>
            </div>
